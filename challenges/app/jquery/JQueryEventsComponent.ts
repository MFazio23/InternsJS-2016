...
export class JQueryEventsComponent extends Challenge {
    ...
    constructor(challengeService: ChallengeService) {
        super(
            new ChallengeConfig(
                'jquery-events',
                'jQuery - Events',
                `This challenge covers how event handling in jQuery works.<br><js-events></js-events>`,
                '/challenges/jquery-events.js',
                [
    ...
    checkChallenge(challengeConfig: ChallengeConfig) {
        ...
        var events = require('/challenges/jquery-events.js');
